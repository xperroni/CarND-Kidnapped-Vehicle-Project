...
class ParticleFilter {
	...
	/**
	 * @brief Transform the given landmark observations to the map's coordinate system.
	 */
	std::vector<LandmarkObs> toMapCoordinates(const Particle &p, const std::vector<LandmarkObs> &observations);

	/**
	 * @brief Return a predicted observation for each mapped observation.
	 */
